          ...
          <div class="flex">
            ...
            >
              <template #item="{ element: [tabID, tabMeta] }">
                ...
                >
                  <span v-if="tabMeta.icon" class="flex items-center justify-center cursor-pointer">
                    <component :is="tabMeta.icon" class="w-4 h-4 svg-icons" />
                  </span>

                  <div v-if="!tabMeta.tabhead" class="w-full px-2 text-left truncate">
                    <span class="truncate">
                      {{ tabMeta.label }}
                    </span>
                  </div>
                  ...
                  <div v-if="tabMeta.suffix" class="flex items-center justify-center">
                  ...
                  <HoppButtonSecondary
                    ...
                    :class="[
                      { active: modelValue === tabID },
                      {
                        ...
                        'hidden group-hover:flex': tabMeta.closeVisibility === 'hover',
