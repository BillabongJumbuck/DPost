<template>
  <div class="flex flex-col">
    ...
    <div
      class="mt-4 relative codegen-loading-container"
      v-loading="isLoading"
      element-loading-text="正在生成请求代码..."
    >
      <div
        v-if="errorState"
...
import { CopyIcon as IconCopy, CheckIcon as IconCheck, CodeIcon as IconCode } from 'lucide-vue-next'
...
// 组件挂载时触发一次生成
onMounted(async () => {
  console.log('Codegen 组件已挂载，执行初始生成')
  if (props.request) {
    await generateAndDisplayCode(props.request, codegenType.value)
  }
})
